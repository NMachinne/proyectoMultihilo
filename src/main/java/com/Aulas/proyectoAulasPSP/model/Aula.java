...
public class Aula extends Thread {
	...
	/**
	 * funcion que se usa como hilo de  productor 
	 * @param alumno
	...
	/**
	 * funcion que se usa como hilo de  consumidor 
	 * @throws InterruptedException
	 */
	public synchronized void  MuestraAlumnos() throws InterruptedException {
		while (true) {
			synchronized (this) {
				...
				muestraTexto(nAulas,
						"El Alumno:  " + elimprimero + " ha entrado en el Aula hace: " + random + " segundos");
				notifyAll();
	 ...
	 * @param nombre
	 */
	private synchronized void muestraTexto(ListView<String> nalum, String nombre) {
